                    ...
                    <div class="panel-body">
                        <div class="row">
							...
							<%	
								int id = 0;
								String oldName = "";
								if(request.getAttribute("objOldCat") != null) {
									Category objOldCat = (Category)request.getAttribute("objOldCat");
									id = objOldCat.getId();
									oldName = objOldCat.getName();
								}
							%>
							
                                <form role="form" method="post" action="<%=request.getContextPath()%>/admin/news/cat/edit?id=<%=id %>" id="form">
