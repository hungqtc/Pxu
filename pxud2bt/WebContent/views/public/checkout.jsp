...
<![endif]-->
  ...
  <body>
              ...
              <div class="header_top">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <ul class="usermenu">
                      <li>
                        <a href="checkout.jsp" class="log">
                          Login
                        </a>
                      </li>
                      <li>
                        <a href="checkout2.jsp" class="reg">
                          Register
                        </a>
                      </li>
                    </ul>
                  ...
                  <li class="option-cart">
                    ...
                    <ul class="option-cart-item">
                      ...
                      <li>
                        <div class="cart-item">
                          <div class="image">
                            <img src="<%=request.getContextPath() %>/images/products/thum/products-02.png" alt="">
                          </div>
                          <div class="item-description">
                            <p class="name">
                              Lincoln chair
                      ...
                      <li>
                        ...
                        <button class="checkout" onClick="location.href='checkout.jsp'">
                          CheckOut
                        </button>
                      </li>
                    </ul>
                    ...
                    <li class="active dropdown">
                      ...
                      <div class="dropdown-menu">
                        <ul class="mega-menu-links">
                          ...
                          <li>
                            <a href="productlitst.jsp">
                              Productlitst
                            </a>
                          </li>
                          <li>
                            <a href="productgird.jsp">
                              Productgird
                            </a>
                          </li>
                          <li>
            ...
            <div class="col-md-9">
              <div class="checkout-page">
                <ol class="checkout-steps">
                  ...
                  <li class="steps">
                    <a href="checkout2.jsp" class="step-title">
    ...
    <script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery-1.10.2.min.js">
    </script>
    <script type="text/javascript" src="<%=request.getContextPath() %>/js/bootstrap.min.js">
    </script>
    <script defer src="<%=request.getContextPath() %>/js/jquery.flexslider.js">
    </script>
    <script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery.carouFredSel-6.2.1-packed.js">
    </script>
    <script type="text/javascript" src="<%=request.getContextPath() %>/js/script.min.js" >
    </script>
  </body>
</html>