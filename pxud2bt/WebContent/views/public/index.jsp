...
<html>
   <head>
      ...
      <link href="<%=request.getContextPath() %>/css/sequence-looptheme.css" rel="stylesheet" media="all"/>
   ...
   <body id="home">
                  ...
                  <div class="col-md-10 col-sm-10">
                     <div class="header_top">
                        <div class="row">
                           ...
                           <div class="col-md-3">
                              <ul class="usermenu">
                                 <li><a href="checkout.jsp" class="log">Login</a></li>
                                 <li><a href="checkout2.jsp" class="reg">Register</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="header_bottom">
                        <ul class="option">
                           ...
                           <li class="option-cart">
                              ...
                              <ul class="option-cart-item">
                                 ...
                                 <li><span class="total">Total <strong>$60.00</strong></span><button class="checkout" onClick="location.href='checkout.jsp'">CheckOut</button></li>
                              </ul>
                           </li>
                        </ul>
                        ...
                        <div class="navbar-collapse collapse">
                           <ul class="nav navbar-nav">
                              <li class="active dropdown">
                                 ...
                                 <div class="dropdown-menu">
                                    <ul class="mega-menu-links">
                                       ...
                                       <li><a href="home2.jsp">home2</a></li>
                                       <li><a href="home3.jsp">home3</a></li>
                                       <li><a href="productlitst.jsp">Productlitst</a></li>
                                       <li><a href="productgird.jsp">Productgird</a></li>
                                       <li><a href="details.jsp">Details</a></li>
                                       <li><a href="cart.jsp">Cart</a></li>
                                       <li><a href="checkout.jsp">CheckOut</a></li>
                                       <li><a href="checkout2.jsp">CheckOut2</a></li>
                                       <li><a href="contact.jsp">contact</a></li>
                                    </ul>
                                 </div>
                              </li>
                              <li><a href="productgird.jsp">men</a></li>
                              <li><a href="productlitst.jsp">women</a></li>
                              <li class="dropdown">
                                 ...
                                 <div class="dropdown-menu mega-menu">
                                    <div class="row">
                                       <div class="col-md-6 col-sm-6">
                                          <ul class="mega-menu-links">
                                             <li><a href="productgird.jsp">New Collection</a></li>
                                             <li><a href="productgird.jsp">Shirts & tops</a></li>
                                             <li><a href="productgird.jsp">Laptop & Brie</a></li>
                                             <li><a href="productgird.jsp">Dresses</a></li>
                                             <li><a href="productgird.jsp">Blazers & Jackets</a></li>
                                             <li><a href="productgird.jsp">Shoulder Bags</a></li>
                                          </ul>
                                       </div>
                                       <div class="col-md-6 col-sm-6">
                                          <ul class="mega-menu-links">
                              ...
                              <li><a href="productgird.jsp">gift</a></li>
                              <li><a href="productgird.jsp">kids</a></li>
                              <li><a href="productgird.jsp">blog</a></li>
                              <li><a href="productgird.jsp">jewelry</a></li>
                        ...
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="details.jsp"><img src="images/products/small/products-01.png" alt="Product Name"></a></div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.jsp"><img src="images/products/small/products-02.png" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 5s Gold 32 Gb 2013</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="details.jsp"><img src="images/products/small/products-03.png" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 5s Gold 32 Gb 2013</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.jsp"><img src="images/products/small/products-04.png" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 5s Gold 32 Gb 2013</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                  ...
                  <ul id="featured">
                     <li>
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.jsp"><img src="images/products/small/products-05.png" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 5s Gold 32 Gb 2013</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.jsp"><img src="images/products/small/products-06.png" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 5s Gold 32 Gb 2013</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="offer">New</div>
                                 <div class="thumbnail"><a href="details.jsp"><img src="images/products/small/products-07.png" alt="Product Name"></a></div>
                                 <div class="productname">Iphone 5s Gold 32 Gb 2013</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
	  ...
	  <script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery.sequence-min.js"></script>
	  <script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery.carouFredSel-6.2.1-packed.js"></script>
	  <script defer src="<%=request.getContextPath() %>/js/jquery.flexslider.js"></script>
	  <script type="text/javascript" src="<%=request.getContextPath() %>/js/script.min.js" ></script>
   </body>
</html>