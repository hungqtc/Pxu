<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@include file="/BT2/inc/header.jsp"%>
...
<div class="container_12">
		...
		<div class="float-left">
			<a href="<%=request.getContextPath()%>/BT2/add.jsp" class="button">
				<span>Thêm sản phẩm mới <img
					src="<%=request.getContextPath()%>/BT2/images/plus-small.gif"
					alt="Thêm tin mới">
			</span>
			</a>
		</div>
					...
					<table id="myTable" class="tablesorter">
						...
						<tbody>
							<tr>
								...
								<td>Khai trương</td>
								<td align="center"><img
									src="<%=request.getContextPath()%>/BT2/images/tmp/hoa1.jpg"
									class="hoa" /></td>
								<td align="center"><a href="">Sửa <img
										src="<%=request.getContextPath()%>/BT2/images/pencil.gif"
										alt="edit" /></a> <a href="">Xóa <img
										src="<%=request.getContextPath()%>/BT2/images/bin.gif"
							...
							<tr>
								...
								<td>Khai trương</td>
								<td align="center"><img
									src="<%=request.getContextPath()%>/BT2/images/tmp/hoa2.jpg"
									class="hoa" /></td>
								<td align="center"><a href="">Sửa <img
										src="<%=request.getContextPath()%>/BT2/images/pencil.gif"
										alt="edit" /></a> <a href="">Xóa <img
							...
							<tr>
								...
								<td>Hoa kỷ niệm</td>
								<td align="center"><img
									src="<%=request.getContextPath()%>/BT2/images/tmp/hoa3.jpg"
									class="hoa" /></td>
								<td align="center"><a href="">Sửa <img
										src="<%=request.getContextPath()%>/BT2/images/pencil.gif"
										alt="edit" /></a> <a href="">Xóa <img
							...
							<tr>
								...
								<td>Hoa tình yêu</td>
								<td align="center"><img
									src="<%=request.getContextPath()%>/BT2/images/tmp/hoa4.jpg"
									class="hoa" /></td>
								<td align="center"><a href="">Sửa <img
										src="<%=request.getContextPath()%>/BT2/images/pencil.gif"
										alt="edit" /></a> <a href="">Xóa <img
							...
							<tr>
								...
								<td>Hoa hạnh phúc</td>
								<td align="center"><img
									src="<%=request.getContextPath()%>/BT2/images/tmp/hoa5.jpg"
									class="hoa" /></td>
								<td align="center"><a href="">Sửa <img
										src="<%=request.getContextPath()%>/BT2/images/pencil.gif"
										alt="edit" /></a> <a href="">Xóa <img
	...
	<%@include file="/BT2/inc/footer.jsp"%>