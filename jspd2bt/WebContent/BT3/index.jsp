	...
	<div class="main-content">
		...
		<div class="body-right fr">
			<div class="news-block">
				<h2 class="title-cat">
					<a href="<%=request.getContextPath()%>/BT3/danhmuc.jsp"
						title="Toàn cảnh Nhật Bản">Toàn cảnh Nhật Bản</a>
				</h2>
				<div class="content-cat">
					<div class="item-left fl">
						<a href="<%=request.getContextPath()%>/BT3/chitiet.jsp"
							...
							href="<%=request.getContextPath()%>/BT3/chitiet.jsp"
					...
					<div class="item-right fr">
						<ul>
							<li><a href="<%=request.getContextPath() %>/BT3/chitiet.jsp"
								title="Đền thiêng Sefa Utaki ở Okinawa" class="title">Đền
									thiêng Sefa Utaki ở Okinawa</a>
								<p class="cat-date">
									<a href="<%=request.getContextPath() %>/BT3/danhmuc.jsp" title="Toàn cảnh Nhật Bản">Toàn cảnh
							...
							<li><a href="<%=request.getContextPath() %>/BT3/chitiet.jsp" title="Cây cầu lớn Seto Naikai"
